...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    names.add(SpringApplicationRunListener.class, "com.vaadin.flow.spring.DevModeBrowserLauncher");
    ...
    factories.add(org.springframework.boot.autoconfigure.template.TemplateAvailabilityProvider.class, () -> new org.springframework.boot.autoconfigure.freemarker.FreeMarkerTemplateAvailabilityProvider());
    ...
    factories.add(StaticResourceProvider.class, () -> org.springframework.data.rest.webmvc.halexplorer._FactoryProvider.halExplorerConfiguration());
