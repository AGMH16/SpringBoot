  ...
  public static void registerHateoasConfiguration(DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.hateoas.config.HateoasConfiguration", HateoasConfiguration.class)
        .instanceSupplier((instanceContext) -> {
          ...
          public static void registerWebFluxHateoasConfiguration(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("org.springframework.hateoas.config.WebFluxHateoasConfiguration", WebFluxHateoasConfiguration.class)
                .instanceSupplier(WebFluxHateoasConfiguration::new).register(beanFactory);
          }

          public static void registerWebFluxHateoasConfiguration_hypermediaWebFluxConfigurer(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("hypermediaWebFluxConfigurer", WebFluxHateoasConfiguration.HypermediaWebFluxConfigurer.class).withFactoryMethod(WebFluxHateoasConfiguration.class, "hypermediaWebFluxConfigurer", ObjectProvider.class, List.class, Optional.class)
                .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(WebFluxHateoasConfiguration.class).hypermediaWebFluxConfigurer(attributes.get(0), attributes.get(1), attributes.get(2)))).register(beanFactory);
          }

          public static void registerWebFluxHateoasConfiguration_serverWebExchangeContextFilter(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("serverWebExchangeContextFilter", ServerWebExchangeContextFilter.class).withFactoryMethod(WebFluxHateoasConfiguration.class, "serverWebExchangeContextFilter")
                .instanceSupplier(() -> beanFactory.getBean(WebFluxHateoasConfiguration.class).serverWebExchangeContextFilter()).customize((bd) -> bd.setLazyInit(true)).register(beanFactory);
          }

          public static void registerWebClientHateoasConfiguration(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("org.springframework.hateoas.config.WebClientHateoasConfiguration", WebClientHateoasConfiguration.class)
                .instanceSupplier(WebClientHateoasConfiguration::new).register(beanFactory);
          }

          public static void registerWebClientHateoasConfiguration_webClientConfigurer(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("webClientConfigurer", HypermediaWebClientConfigurer.class).withFactoryMethod(WebClientHateoasConfiguration.class, "webClientConfigurer", ObjectProvider.class, List.class)
                .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(WebClientHateoasConfiguration.class).webClientConfigurer(attributes.get(0), attributes.get(1)))).customize((bd) -> bd.setLazyInit(true)).register(beanFactory);
          }

          public static void registerWebClientHateoasConfiguration_webClientBeanPostProcessor(
              DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("webClientBeanPostProcessor", WebClientHateoasConfiguration.HypermediaWebClientBeanPostProcessor.class).withFactoryMethod(WebClientHateoasConfiguration.class, "webClientBeanPostProcessor", ObjectFactory.class)
                .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> WebClientHateoasConfiguration.webClientBeanPostProcessor(attributes.get(0)))).register(beanFactory);
          }
        }
